                      ...
                      <div class="col-sm-4 pt-3">
                        <div class="card" style="width: 18rem;">
                          ...
                          <ul class="list-group list-group-flush">
                              ...
                              <li class="list-group-item btn btn-dark"><a class="btn btn-danger btn-lg btn-block" href="updateMK.php?id=' . $row['item_id'] . '">Update</a></li>
                              <li class="list-group-item"><a class="btn btn-danger" href="deleteMK.php?item_id=' . $row['item_id'] . '">Delete Item</a></li>
                          </ul>
                      </div>
                  </div>';
              }
